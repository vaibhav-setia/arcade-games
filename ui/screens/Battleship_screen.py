...
class BattleshipScreen(Screen):
    ...
    def ui_layout(self):
        ...
        self.start_game_button = MDFloatingActionButton(icon='record', size=[dp(56), dp(56)])
        ...
        decode_text = """You probably already know how to play Tic-Tac-Toe. It's a really simple game, right? That's what most people think. But if you really wrap your brain around it, you'll discover that Tic-Tac-Toe isn't quite as simple as you think!
        ...
        """
        decode_label = MDLabel(text=decode_text, font_style='Body1', halign='center',
                               size_hint=(1, 0.5))
